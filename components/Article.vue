...
.article {
    ...
    .article-meta {
        ...
        .article-author {
            ...
            .author-img {
                @apply w-8 h-8 bg-red-200 rounded-full;
            }
        ...
        .article-like-btn {
            @apply flex items-center justify-center px-2 text-green-500 border border-green-500;
        }
    }

    .article-title {
        @apply text-xl text-gray-800 mb-1;
    }
